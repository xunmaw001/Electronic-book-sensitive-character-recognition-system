        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="作者简介" prop="zuozheContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zuozheContent" label="作者简介" prop="zuozheContent">
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='zuozheContent'){
                          this.ruleForm.zuozheContent = obj[o];
                          this.ro.zuozheContent = true;
                          continue;
                      }
                    }
                }
